...
export const helpModalTabTexts = {
  ...
  `,
    fifthPrgrph: `
    • Seedhodler and Trezor: Trezor devices expect SLIP-39 shares generated by their own implementation. 
      Seedhodler shares are incompatible and will reconstruct a different SLIP-39 master seed without errors, 
      leading to an unrelated wallet.
    • Irrecoverable Wallets: Mixing systems can result in permanent loss of access to your original wallet.
  `,
    sixthPrgrph: `
    Key Guidelines:
  `,
    seventhPrgrph: `
    1. Use Seedhodler Exclusively for BIP39 Wallets: This approach works seamlessly with BIP39 wallets 
       like Ledger.
    2. Do Not Mix Systems: Never mix Seedhodler shares with those from other tools (e.g., Trezor's SLIP-39).
    3. Verify Before Use: After reconstruction, compare the first derived Bitcoin address to the original 
       wallet’s address to confirm the seed’s correctness.
  `,
    eighthPrgrph: `
    By following these steps, you can securely split and recover BIP39 master seeds while maintaining 
    compatibility with your chosen wallet.
  `,
  },
  WARNING: {
    title: "Warning: How It Works",
    intro: `
      Seedhodler leverages the <b>SLIP-39 library developed by Satoshi Labs</b>, the creators of Trezor, 
      to bring <b>Shamir's Secret Sharing (SSS)</b> to any BIP39-compatible wallet, such as Ledger. 
      This approach enables secure seed splitting while extending the benefits of SSS to wallets 
      that support BIP39 but not SLIP-39.
    `,
    parts: [
      {
        title: `How Seedhodler Works`,
        list: [
          `<b>Seed Splitting</b>: Seedhodler splits a BIP39 master seed into cryptographically secure shares 
        using the SLIP-39 library.`,
          `<b>BIP39 Compatibility</b>: By treating BIP39 seeds as SLIP-39, Seedhodler makes SSS available 
        for wallets like Ledger`,
          `<b>Reconstruction</b>: With the required number of shares (threshold), Seedhodler reconstructs 
        the original BIP39 seed for use in any compatible wallet.`,
        ],
      },
      {
        title: `Important Compatibility Notes`,
        list: [
          `<b>Seedhodler and Trezor</b>: Trezor devices expect SLIP-39 shares generated by their own implementation. 
        Seedhodler shares are incompatible and will reconstruct a different SLIP-39 master seed without errors, 
        leading to an unrelated wallet.`,
          `<b>Irrecoverable Wallets</b>: Mixing systems can result in permanent loss of access to your original wallet.`,
        ],
      },
      {
        title: `Key Guidelines`,
        list: [
          `<b>Use Seedhodler Exclusively for BIP39 Wallets</b>: This approach works seamlessly with BIP39 wallets 
         like Ledger.`,
          `<b>Do Not Mix Systems</b>: Never mix Seedhodler shares with those from other tools (e.g., Trezor's SLIP-39).`,
          `<b>Verify Before Use</b>: After reconstruction, compare the first derived Bitcoin address to the original 
         wallet’s address to confirm the seed’s correctness.`,
        ],
      },
    ],
    outro: `By following these steps, you can securely split and recover BIP39 master seeds while maintaining 
      compatibility with your chosen wallet.`,
  },
