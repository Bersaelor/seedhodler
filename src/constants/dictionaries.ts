...
export const helpModalTabTexts = {
  ...
  WARNING: {
    title: "Do not mix and match!",
    firstPrgrph: `                
    Seedhodler leverages the SLIP-39 library developed by Satoshi Labs, the creators of Trezor, 
    to bring Shamir's Secret Sharing (SSS) to any BIP39-compatible wallet, such as Ledger. 
  ...
  `,
    secondPrgrph: `
    • Seed Splitting: Seedhodler splits a BIP39 master seed into cryptographically secure shares 
      using the SLIP-39 library.
    • BIP39 Compatibility: By treating BIP39 seeds as SLIP-39, Seedhodler makes SSS available 
      for wallets like Ledger.
    • Reconstruction: With the required number of shares (threshold), Seedhodler reconstructs 
